...
- 🖥 **Front-end:** 
  ...
  - **🔬 Frameworks:**  
    ...
    - **🌐 Web:** • [PixiJS](https://pixijs.io/) • [Blazor WASM](https://dotnet.microsoft.com/en-us/apps/aspnet/web-apps/blazor) • [Uno WASM](https://platform.uno/uno-platform-for-web-webassembly/) • [Open Silver](https://opensilver.net/) • [ASP.NET MVC](https://dotnet.microsoft.com/en-us/apps/aspnet/mvc) • [React](https://react.dev/)
